...
val versionNameProp = (project.findProperty("versionName") as? String).orEmpty().ifEmpty { "2.8.1" }
val versionCodeProp = (project.findProperty("versionCode") as? String)?.toIntOrNull() ?: 28100
