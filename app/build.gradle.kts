...
val versionNameProp = (project.findProperty("versionName") as? String).orEmpty().ifEmpty { "2.3.0" }
val versionCodeProp = (project.findProperty("versionCode") as? String)?.toIntOrNull() ?: 5
