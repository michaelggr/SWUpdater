...
val versionNameProp = (project.findProperty("versionName") as? String).orEmpty().ifEmpty { "2.7.3" }
val versionCodeProp = (project.findProperty("versionCode") as? String)?.toIntOrNull() ?: 27003
